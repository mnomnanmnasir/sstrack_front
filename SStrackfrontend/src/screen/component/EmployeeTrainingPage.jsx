...
const videos = [
  ...
  },
  {
    ...
    description:
      "Understand how SS Track respects your privacy and what’s actually being tracked—only when you choose to.",
    script:
  ...
  },
  {
    ...
    description:
      "Track time, request leave, check your schedule, and more — all from the SS Track mobile app.",
    script:
    ...
    <div className="p-6 max-w-6xl mx-auto bg-white min-h-screen">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-700">
          Learn how to use SS Track as an employee. These short guides help you track your time, understand privacy, and manage your tasks on desktop or mobile.
        </p>
      </div>
