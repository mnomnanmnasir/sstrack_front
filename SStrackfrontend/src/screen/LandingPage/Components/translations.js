const translations = {
    ...
    ar: {
      ...
      description: "من العمل من المنزل إلى المكتب، في الموقع، في الميدان، أو في أي موقع عمل محدد، يوفر SS Track.io تتبعًا دقيقًا، وإدارة سلسة، وحلول فريق أكثر ذكاءً. تتبع عبر منصات Windows و Mac و Android و iOS و Chrome بكفاءة لا مثيل لها.",
      signUpPlaceholder: "أدخل بريدك الإلكتروني",
      signUpButton: "سجل",
      availablePlatforms: "يتوفر SS Track عبر جميع المنصات الرئيسية للوصول السلس",
    }
  };
