...
function UserDetails() {
    ...
    function handleBlurSS(timeEntId, ssId) {
        setData((prevData) => {
            return {
                ...prevData,
                                                ...
                                                return loading ? (
                                                    ...
                                                    <div className="projectAdd" onMouseOver={() => setShowDeleteButton(true)} onMouseOut={() => setShowDeleteButton(false)}>
                                                        ...
                                                        <div className="screenShotImg">
                                                            <img style={{ filter: elements?.blur === true ? "blur(3px)" : "" }} className="screenshotiimage" onClick={() => openModal(element, elements?.key, index)} src={elements?.key} alt="ScreenShotImg.png" />
                                                        </div>
                                                    </div>
                                                )
                                            }))}
                                                ...
                                                <div className="fullscreen-screenshot-model">
                                                    ...
                                                    <div className="ss-image">
                                                        <div className="d-flex align-items-center gap-5">
                                                            ...
                                                            <div>
                                                                <img style={{ filter: ssData?.screenshots.find((f, indd) => indd === selectedImageIndex)?.blur === true ? "blur(3px)" : ""}} className="modalImage" src={selectedImage} alt="Pop-up Image" />
                                                            </div>
                                                            <div
                                                                onClick={() => {
