                ...
                <div className="card mx-auto" style={{ width: "18rem", width: '100%' }}>
                  ...
                  <div className="card-body">
                    ...
                    <p className="text-end" style={{ fontSize: "20px", color: "#0E4772", fontWeight: 500, marginTop: '4%' }}>
                      After selecting a plan, a company manager invites employees to the SSTRACK team. When employees accept the invitation, they can start tracking time and submitting their screenshots for that company.
                    </p>
                    <img
                      src={screenShot1}
                ...
                <div className="card mx-auto" style={{ width: "18rem", width: '100%' }}>
                  ...
                  <div className="card-body">
                    ...
                    <p className="text-start" style={{ fontSize: "20px", color: "#0E4772", fontWeight: 500, marginTop: '4%' }}>
                      Employees install the SSTRACK desktop application, log in, select a project, and press the Start button to begin tracking time and taking screenshots. The application functions offline, and data is uploaded to the web once the internet connection is restored.
                    </p>
                    <img
                      src={screenShot}
              ...
              <div className="col-md-5 col-sm-12 col-lg-6" style={{ borderRight: '2px solid #bfb4b4' }}>
                <div className="card mx-auto" style={{ width: "18rem", width: '100%' }}>
                  ...
                  <div className="card-body">
                    ...
                    <p className="text-end" style={{ fontSize: "20px", color: "#0E4772", fontWeight: 500, marginTop: '4%' }}>
                      The SSTRACK application tracks employee time and takes screenshots at random intervals until the Stop button is pressed. With the Autostart option, the program starts with computer use and stops if inactive, ideal for in-office tracking. Employees are always aware SSTRACK is running, as it cannot operate in stealth mode.
                    </p>
                    <img
                      src={screenShot3}
                      className="card-img-bottom flex-end insideCardSS"
              ...
              <div className="col-md-5 col-sm-12 col-lg-6 mb-3" style={{ marginLeft: '1px solid #FFF' }}>
                ...
                /> */}
                  <div className="card-body">
                    ...
                    <p className="text-start" style={{ fontSize: "20px", color: "#0E4772", fontWeight: 500, marginTop: '4%' }}>
                      The SSTRACK app sends time tracking data and screenshots to the web, allowing real-time monitoring by managers. Managers can view all information online without installation. The dashboard displays work times, current activity, and recent screenshots.
                    </p>
                    <img
                      src={screenShot4}
                      className="card-img-top flex-start insideCardSS"
