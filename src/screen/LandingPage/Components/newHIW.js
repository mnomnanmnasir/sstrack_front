                ...
                <Col xs={12} md={6} lg={4} className="p-0 mt-lg-5 d-flex justify-content-center">
                    <StepCard
                        ...
                        description={language === 'en'
                            ...
                            : 'أنشئ حسابك على SSTrack.io. الأمر سريع وسهل—فقط أدخل بياناتك، وستكون جاهزًا للانطلاق.'}
                        language={language}
                    />
                </Col>
                ...
                <Col xs={12} md={6} lg={4} className="p-0 mt-lg-5 d-flex justify-content-center">
                    <StepCard
                        ...
                        description={language === 'en'
                            ...
                            : 'يجب على كل عضو في الفريق تثبيت تطبيق SSTrack.io على جهازه. بمجرد بدء العمل، تتم مزامنة بيانات الوقت والنشاط مع لوحة التحكم في الوقت الفعلي.'}
                        language={language}
                    />
                </Col>
                <Col xs={12} md={6} lg={4} className="p-1 d-flex justify-content-center second-card">
